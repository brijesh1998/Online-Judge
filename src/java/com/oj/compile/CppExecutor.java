...
public class CppExecutor extends ProcessExecutor {
    ...
    public CppExecutor(String usercode, String testdata, String webpath, String srcpath, ProcessExecutor nextExecutor, String lan) {
    ...
    public boolean compile() {
        ...
        boolean done=false;
        try {
            String cmd="g++ "+ webpath+usercode + " -o "+srcpath+"/com/oj/compile/run.out";
